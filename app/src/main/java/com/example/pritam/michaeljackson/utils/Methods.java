package com.example.pritam.michaeljackson.utils;
...
public class Methods {
    ...
    public static boolean isNetworkAvailable() {
        ConnectivityManager connectivityManager
                = (ConnectivityManager) JacksonAppContext.getAppContext().getSystemService(Context.CONNECTIVITY_SERVICE);
        NetworkInfo activeNetworkInfo = connectivityManager.getActiveNetworkInfo();
        return activeNetworkInfo != null && activeNetworkInfo.isConnected();
    }

    public static void showPromptMessage(String msg) {
        Toast.makeText(JacksonAppContext.getAppContext(), msg, Toast.LENGTH_LONG).show();
    }
